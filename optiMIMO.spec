...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'mimo_acoustic.cli',
        'mimo_acoustic.core',
        'mimo_acoustic.core.io',
        'mimo_acoustic.core.pipeline',
        'mimo_acoustic.core.smoothing',
        'mimo_acoustic.core.solver',
        'mimo_acoustic.core.targets',
        'mimo_acoustic.export',
        'mimo_acoustic.export.camilladsp',
        'mimo_acoustic.export.firs',
        'mimo_acoustic.gui',
        'mimo_acoustic.gui.app',
        'mimo_acoustic.gui.analysis_tab',
        'mimo_acoustic.gui.config_tab',
        'mimo_acoustic.gui.file_picker',
        'mimo_acoustic.gui.measurements_tab',
        'mimo_acoustic.gui.plots',
        'mimo_acoustic.gui.run_tab',
        'mimo_acoustic.gui.state',
        'mimo_acoustic.util',
